...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'form.middle_name' => 'nomes do meio',
        'form.last_name' => 'apelido',
        'form.father_name' => 'nome do pai',
        'form.mother_name' => 'nome da mãe',
        'form.gender_id' => 'género',
        'form.birth_date' => 'data de nascimento',
        'form.birth_country_id' => 'país de nascimento',
        'form.birth_province_id' => 'província de nascimento',
        'form.birth_district_id' => 'distrito de nascimento',
        'form.marital_status_id' => 'estado civil',
        'form.nationality_id' => 'nacionalidade',
        'form.identity_document_id' => 'tipo de documento',
        'form.identity_document_number' => 'número do documento',
        'form.identity_document_issue_date' => 'data de emissão',
        'form.identity_document_expiry_date' => 'data de validade',
        'form.living_country_id' => 'país de residência',
        'form.living_province_id' => 'província de residência',
        'form.living_district_id' => 'distrito de residência',
        'form.neighborhood' => 'bairro de residência',
        'form.living_address' => 'endereço',
        'form.phone_2' => 'telefone alternativo',
        'form.phone_whatsapp' => 'telefone com WhatsApp',
        'form.degree_type' => 'licenciatura em',
        'form.university' => 'instituição onde concluiu o ensino superior',
        'form.university_start_year' => 'ano de início',
        'form.university_end_year' => 'ano de término',
        'form.university_country_id' => 'país onde concluiu a licenciatura',
        'form.university_city_district' => 'cidade/distrito onde concluiu a licenciatura',
        'form.university_final_grade' => 'nota final da licenciatura',
        'form.high_school_institution' => 'instituição onde concluiu o ensino médio',
        'form.high_school_country_id' => 'país onde concluiu o ensino médio',
        'form.high_school_city_district' => 'cidade/distrito onde concluiu o ensino médio',
        'form.high_school_completion_year' => 'ano de conclusão do ensino médio',
        'form.high_school_final_grade' => 'nota de conclusão do ensino médio',
