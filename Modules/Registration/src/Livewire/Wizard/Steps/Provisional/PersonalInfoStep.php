...
class PersonalInfoStep extends StepComponent
{
    ...
    public function saveAndNext(): void
    {
        ...
        // Validate eligibility based on selected subtype
        ...
        if ($registrationType) {
            ...
            $validation = $eligibilityService->validateForProvisional($eligibilityData, $subtype);
    ...
    {
        return view('registration::livewire.registration.wizard.steps.provisional.personal-info');
    }
}
