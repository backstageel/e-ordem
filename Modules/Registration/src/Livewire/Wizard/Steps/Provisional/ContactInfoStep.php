...
class ContactInfoStep extends StepComponent
{
    ...
    public function continue(): void
    {
        ...
        // Get selected subtype and registration type
        $subtype = (int) ($this->state()->forStepClass(\Modules\Registration\Livewire\Wizard\Steps\Provisional\ChooseSubtypeStep::class)['subtype'] ?? 0);
        ...
        $temp->setStepData(1, ['subtype' => $subtype]);
        $temp->setStepData(2, [
            'email' => $this->email,
            'phone' => $this->phone,
        ]);
    ...
    {
        return view('registration::livewire.registration.wizard.steps.provisional.contact-info');
    }
}
