...
class ContactInfoStep extends StepComponent
{
    ...
    public function continue(): void
    {
        ...
        $category = (int) ($this->state()->forStepClass(\Modules\Registration\Livewire\Wizard\Steps\Certification\ChooseCategoryStep::class)['category'] ?? 0);
    ...
    {
        return view('registration::livewire.registration.wizard.steps.certification.contact-info');
    }
}
