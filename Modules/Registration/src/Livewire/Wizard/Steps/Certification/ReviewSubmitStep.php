...
class ReviewSubmitStep extends StepComponent
{
    public function summary(): array
    {
        ...
        $feeCalculation = $registrationType
            ? app(FeeCalculationService::class)->calculateForCertification($category)
    ...
    {
        return view('registration::livewire.registration.wizard.steps.certification.review-submit', [
