    ...
    <div class="container-fluid">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Lista de Inscrições</li>
            </ol>
        </nav>
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="page-header d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <div>
                        <h3 class="fw-bold mb-1">Gestão de Inscrições</h3>
                        <p class="text-muted mb-0">Gerir todas as inscrições médicas do sistema.</p>
                    </div>
                    <div class="d-flex align-items-center flex-wrap gap-2">
                        <a class="btn btn-primary d-inline-flex align-items-center" href="{{ route('admin.registrations.type-selection') }}">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <div>
                                ...
                                <h3 class="fw-bold mb-0">{{ $rejectedCount ?? 0 }}</h3>
                            </div>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                                        <img src="https://ui-avatars.com/api/?name={{ urlencode($registration->person->full_name) }}&background=e9f0e6&color=2d5016" class="rounded-circle border" alt="Foto" width="40" height="40">
                                                    </div>
                                                    <div class="ms-3">
