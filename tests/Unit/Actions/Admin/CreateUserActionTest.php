...
it('action class has proper namespace', function () {
    $action = new CreateUserAction();
    expect(get_class($action))->toBe('App\Actions\Admin\CreateUserAction');
});

it('action class extends base class', function () {
    $action = new CreateUserAction();
    expect($action)->toBeInstanceOf('App\Actions\Admin\CreateUserAction');
});
...
it('action can be unserialized', function () {
    ...
    expect($unserialized)->toBeInstanceOf(CreateUserAction::class);
});
...
it('action class has proper file location', function () {
    ...
    expect($filename)->toContain('CreateUserAction.php');
});
