...
it('action class has proper namespace', function () {
    $action = new UpdateUserAction();
    expect(get_class($action))->toBe('App\Actions\Admin\UpdateUserAction');
});

it('action class extends base class', function () {
    $action = new UpdateUserAction();
    expect($action)->toBeInstanceOf('App\Actions\Admin\UpdateUserAction');
});
...
it('action can be unserialized', function () {
    ...
    expect($unserialized)->toBeInstanceOf(UpdateUserAction::class);
});
...
it('action class has proper file location', function () {
    ...
    expect($filename)->toContain('UpdateUserAction.php');
});
